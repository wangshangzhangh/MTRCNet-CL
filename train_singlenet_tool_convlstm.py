...
parser.add_argument('-t', '--train', default=400, type=int, help='train batch size, default 100')
...
def train_model(train_dataset, train_num_each, val_dataset, val_num_each):
    ...
    for epoch in range(epochs):
        ...
        for data in train_loader:
            ...
            preds_1 = torch.ByteTensor((sig_out.cpu() > 0.5).byte())
...
def main():
    train_dataset, train_num_each, val_dataset, val_num_each, _, _ = get_data('/home/hp/ProcessingData/train_val_test_paths_labels.pkl')
